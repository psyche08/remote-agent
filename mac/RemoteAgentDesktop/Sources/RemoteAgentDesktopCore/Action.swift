...
public struct Action: Sendable, Equatable {
    ...
    init(
        id: ActionID, x: Int = 0, y: Int = 0, button: MouseButton = .left,
...
public struct ActionRequest: Codable, Sendable {
    ...
    public init(
        action: String, x: Int? = nil, y: Int? = nil, button: String? = nil,
...
extension Action {
    ...
    public static func parse(_ request: ActionRequest) throws -> Action {
        ...
        case .pointerMove:
            let (x, y) = try requirePoint(request)
            return Action(id: id, x: x, y: y)
        ...
        case .pointerClick:
            ...
            return Action(id: id, x: x, y: y, button: button, count: count)
        ...
        case .pointerScroll:
            ...
            return Action(id: id, x: x, y: y, deltaX: dx, deltaY: dy)
    ...
    private static func requirePoint(_ request: ActionRequest) throws -> (Int, Int) {
